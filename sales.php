...
<html lang="ru">
  ...
  <header class="page-header">
	...
	<div class="main">
		<h2 class="items"> Светильник liner/R DR 228 металлик </h2>
		<p><img width="400" src="img/liner228.png" class="item-image" alt="Светильник Liner-228"></p>
		<div class="product-nk__options">
    <h2 class="product-nk-title">Параметры</h2>
    <table align="center" width="60%" class="table table-simple">
    <tbody>
